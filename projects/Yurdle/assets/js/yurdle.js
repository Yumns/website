...
function keyIn(clicked_id) {
    if (document.getElementById("wordIn").value.length >= 5) {
        alert("Words can only be 5 letters!")
    } else {
...
async function delChar() {
    ...
    console.log(lettersArray);
    document.getElementById("wordIn").value = document.getElementById("wordIn").value.slice(0, Number(document.getElementById("wordIn").value.length) - 1);
    lettersIn()
}
    ...
    if (document.getElementById("wordIn").value.length < 5) {
        ...
        fetch(`https://api.dictionaryapi.dev/api/v2/entries/en/${document.getElementById("wordIn").value}`)
            ...
            .then(async function (data) {
                wordCheck = JSON.stringify(data);
                if (wordCheck.includes("No Definitions Found") && words.includes(document.getElementById("wordIn").value) === false) {
                    ...
                    for (i in input) {
                        ...
                        if (input[i] === word[i]) {
                            ...
                            document.getElementById(`${turn}-${i}`).innerHTML = input[i];
                            document.getElementById(`${turn}-${i}`).style.backgroundColor = "#fdfd97";
                            document.getElementById(input[i]).style.backgroundColor = "#fdfd97";
                        } else {
                            document.getElementById(`${turn}-${i}`).innerHTML = input[i];
                            document.getElementById(`${turn}-${i}`).style.backgroundColor = "lightgray";
                            document.getElementById(input[i]).style.backgroundColor = "lightgray";
                        }
                    }
                    if (input.toString() === word.toString()) {
                        wins += 1;
                        winStreak += 1;
